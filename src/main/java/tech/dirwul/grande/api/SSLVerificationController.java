...
public class SSLVerificationController {
	...
	public ResponseEntity<ByteArrayResource> verify() {
		File file = new File("src/main/resources/static/" + VALIDATION_FILE_NAME);
		byte[] contentBytes = file.toString().getBytes();
